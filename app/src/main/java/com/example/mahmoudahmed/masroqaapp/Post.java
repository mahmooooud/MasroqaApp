...
public class Post extends Fragment implements View.OnClickListener{
    ...
    TextView result;
    ArrayList<String> dataOfPost = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View mView = inflater.inflate(R.layout.activity_post, container, false);
    ...
    private void displayChatMessages() {
        ...
        adapter = new FirebaseListAdapter<Posts>(getActivity(), Posts.class, R.layout.post, mReference) {
    ...
    public void onClick(View view) {
        mReference.push().setValue(new Posts(etInputMessage.getText().toString(), Username));
